...
Util.getNav = async function (req, res, next) {
  // Calls the getClassifcation fxn from the inventory-model file
...
Util.buildVehicleDetail = async function(vehicle){
  ...
  if(vehicle){
    ...
    detail += '<p class="price"><strong>Price:</strong> $' 
    + new Intl.NumberFormat('en-US').format(vehicle.inv_price) + '</p>'

    detail += '<p class="description"><strong>Description:</strong> ' 
    + vehicle.inv_description + '</p>'
    
    detail += '<p class="color"><strong>Color:</strong> ' 
    + vehicle.inv_color + '</p>'

    detail += '<p class="mileage"><strong>Mileage:</strong> ' 
